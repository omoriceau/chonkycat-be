...
VALUES
  ...
  ('DRY-CK-001', 'Chonky Kibble – Original Rotisserie Chicken',
   ...
   'img/dry-ck-001.jpg', 'Dry Food', 22.99, 200, 25, 1),
  ...
  ('DRY-CK-002', 'Chonky Kibble – Salmon & Sweet Potato',
   ...
   'img/dry-ck-002.jpg', 'Dry Food', 23.99, 175, 25, 1),
  ...
  ('DRY-CK-003', 'Chonky Kibble – Beef & Brown Rice',
   ...
   'img/dry-ck-003.jpg', 'Dry Food', 22.99, 160, 25, 1),
  ...
  ('DRY-CP-001', 'Chonk+ Kibble – Joint Support Turkey & Glucosamine',
   ...
   'img/dry-cp-001.jpg', 'Dry Food', 31.99, 120, 20, 1),
  ...
  ('DRY-CP-002', 'Chonk+ Kibble – Gravy-Soaked Double Chicken with Beef Drippings',
   ...
   'img/dry-cp-002.jpg', 'Dry Food', 31.99, 90, 20, 1),
  ...
  ('DRY-CP-003', 'Chonk+ Kibble – Hairball Control Duck & Oat',
   ...
   'img/dry-cp-003.jpg', 'Dry Food', 33.99, 8, 20, 1),  -- low stock
  ...
  ('WET-001', 'Rustic Sparrow Pâté with Roasted Seed Jus',
   ...
   'img/wet-001.jpg', 'Wet Food', 4.49, 300, 40, 1),
  ...
  ('WET-002', 'Meadow Vole Minced in Clover Broth',
   ...
   'img/wet-002.jpg', 'Wet Food', 4.49, 280, 40, 1),
  ...
  ('WET-003', 'Cornish Pigeon Confit with Giblet Gravy',
   ...
   'img/wet-003.jpg', 'Wet Food', 4.99, 260, 40, 1),
  ...
  ('WET-004', 'Garter Snake Terrine with Forest Mushroom',
   ...
   'img/wet-004.jpg', 'Wet Food', 4.99, 220, 40, 1),
  ...
  ('WET-005', 'Chipmunk Fricassée with Acorn Butter Sauce',
   ...
   'img/wet-005.jpg', 'Wet Food', 5.29, 190, 35, 1),
  ...
  ('WET-006', 'Field Mouse Bourguignon',
   ...
   'img/wet-006.jpg', 'Wet Food', 5.29, 210, 35, 1),
  ...
  ('WET-007', 'Song Thrush & Worm Medley Pâté',
   ...
   'img/wet-007.jpg', 'Wet Food', 4.79, 240, 40, 1),
  ...
  ('WET-008', 'Baby Rabbit Stew with Tarragon & Marrow',
   ...
   'img/wet-008.jpg', 'Wet Food', 5.49, 170, 30, 1),
  ...
  ('WET-009', 'Shrew Tartare with Quail Egg Crumble',
   ...
   'img/wet-009.jpg', 'Wet Food', 5.49, 6, 30, 1),  -- low stock
  ...
  ('WET-010', 'Roasted Finch Pâté with Sun-Dried Cricket Crust',
   ...
   'img/wet-010.jpg', 'Wet Food', 5.29, 200, 35, 1),
  ...
  ('SNK-001', 'Freeze-Dried Minnow Crisps',
   ...
   'img/snk-001.jpg', 'Snacks', 11.99, 150, 20, 1),
  ...
  ('SNK-002', 'Chonky Chonk Pill Pockets – Chicken Flavour',
   ...
   'img/snk-002.jpg', 'Snacks', 13.99, 130, 20, 1),
  ...
  ('SNK-003', 'Lickable Tuna & Pumpkin Squeeze Tubes (6-pack)',
   ...
   'img/snk-003.jpg', 'Snacks', 9.99, 220, 30, 1),
  ...
  ('SNK-004', 'Crunchy Locust & Catnip Nuggets',
   ...
   'img/snk-004.jpg', 'Snacks', 10.99, 9, 15, 1),  -- low stock
  ...
  ('SNK-005', 'Smoked Anchovy Dental Chews',
   ...
   'img/snk-005.jpg', 'Snacks', 12.99, 110, 20, 1),
  ...
  ('SNK-006', 'Duck Liver Mousse Bites',
   ...
   'img/snk-006.jpg', 'Snacks', 14.99, 75, 15, 1);
...
VALUES
  ('WELCOME10',  'percentage', 10.00, 1, '2026-12-31 23:59:59'),
  ('FLAT5OFF',   'fixed',       5.00, 1, '2026-09-30 23:59:59'),
  ('SUMMER20',   'percentage', 20.00, 0, '2025-08-31 23:59:59');  -- expired/inactive
...
INSERT INTO `orders`
  (`user_id`, `status`, `subtotal`, `tax_amount`, `shipping_amount`, `total_amount`,
   ...
   `shipping_postal_code`, `shipping_country`)
VALUES
  (3, 'completed', 54.97, 7.15, 0.00, 57.97,   -- FLAT5OFF promo deducted from subtotal
...
INSERT INTO `orders`
  (`user_id`, `status`, `subtotal`, `tax_amount`, `shipping_amount`, `total_amount`,
   ...
   `shipping_postal_code`, `shipping_country`)
VALUES
  (6, 'completed', 89.97, 10.52, 0.00, 91.49,   -- WELCOME10 (10%) applied
...
INSERT INTO `order_promotions`
  (`order_id`, `promotion_id`, `discount_amount`)
VALUES
  (5, 1, 9.00);   -- WELCOME10 — 10% of 89.97 ≈ 9.00
